...
/* Definicija strukture osoba koja se sastoji od imena,prezimena,godine rođenja te pokazivača na sljedeći element vezane liste.
...
//Deklaracije funkcija koje ćemo koristiti.
